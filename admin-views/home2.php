                    ...
                    <center>
                        <div class="navbar-collapse collapse" id="navbar-main">
                            <ul class="nav navbar-nav">
                                <li class="active"><a href="home2.php">HOME</a>
                                </li>
                            ...
                            <div class="nav navbar-right">
                                ...
                                <i class="glyphicon glyphicon-user" title="Tài khoản" style="cursor: pointer; padding-left: 10px;padding-right:20px;font-size: 20px"
                                   onclick="
                                    window.location = 'change_info_cus.php';
                                  "></i>
                                <i class="glyphicon glyphicon-log-out" title="Đăng xuất" style="cursor: pointer; padding-left: 20px; padding-right: 20px;font-size: 20px"
                                   onclick="
