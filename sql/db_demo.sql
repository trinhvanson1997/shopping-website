...
; use shop;  DEFAULT CHARACTER SET utf8
  ...
  constraint check_stt check (status in ('active','waiting','inactive','deny'))	  /*dang hoat dong, dang cho phe duyet, dung hoat dong, bi tu choi*/
  );
  ...
  create table if not exists customer(
   ...
   name varchar(100) not null, birthday date not null,
    address varchar(100) not null,
    phone varchar(100) not null,
    username varchar(100) not null,
    primary key (id),
